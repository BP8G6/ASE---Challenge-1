...
public class SignUp extends Activity {
	...
	private EditText FName, LName, Phoneno, Email, Address, City, State, Country, ZipCode, UserName, pwd, cnfpwd;
	...
	submit.setOnClickListener(new View.OnClickListener() {			
		...
		public void onClick(View v) {
			...
			if(firstname.equals("")||lastname.equals("")||phone.equals("")||email.equals("")||city.equals("")||state.equals("")||country.equals("")||zipcode.equals("")||address.equals("")||username.equals("")||password.equals("")||cnfpassword.equals("")) 
			{ 
			...
			{ 			
				...
				{
					register.insertEntry(firstname,lastname,phone,email,address,city,state,country,zipcode,username,password,cnfpassword);
					...
					Intent in = new Intent(SignUp.this,EstoreHome.class);
			         startActivity(in);
