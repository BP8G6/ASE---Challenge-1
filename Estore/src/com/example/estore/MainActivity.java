...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		switch(v.getId()){
	      case R.id.signupbtn: 
	             Intent in_singup = new Intent(MainActivity.this,SignUp.class);
	             startActivity(in_singup);
	         break;
	      case R.id.btn_login:
	    	  Intent in_login = new Intent(MainActivity.this,ListFeatures.class);
	    	   startActivity(in_login); 
	         break;
	     case R.id.guestbtn:
	    	  Intent in_guest = new Intent(MainActivity.this,PaymentInfo.class);
