...
public class RegisterAdapter {
	...
	static final String DATABASE_NAME = "estore.db"; 
	static final int DATABASE_VERSION = 1; 
	public static final int NAME_COLUMN = 1;
	
	
	static final String DATABASE_CREATE = "create table "+"REGISTRATION"+ 
	"( " +"ID"+" integer primary key autoincrement,"+ "FIRSTNAME text,LASTNAME text,PHONE text,EMAIL text,ADDRESS text,CITY text,STATE text,COUNTRY text,ZIPCODE text,USERNAME text,PASSWORD text,CNFPASSWORD text); "; 
    ...
    public void insertEntry(String firstname,String lastname,String email,String phone,String address,String city,String state,String country,String zipcode,String userName,String password,String confirmPassword) 
    { 
    	...
    	//db.insert("BALAKRISHNA", null, newValues);
